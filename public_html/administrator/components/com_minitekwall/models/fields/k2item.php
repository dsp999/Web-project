...
class K2ElementK2Item extends K2Element
{
    ...
    function fetchElement($name, $value, &$node, $control_name)
    {
        ...
        {
            $item->title = JText::_('COM_MINITEKWALL_K2_SELECT_AN_ITEM');
        }
        ...
        if (K2_JVERSION == '30')
        {
            ...
            <a class="modal btn" title="'.JText::_('COM_MINITEKWALL_K2_SELECT_AN_ITEM').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 700, y: 450}}"><i class="icon-file"></i>'.JText::_('K2_SELECT').'</a>
        ...
        else
        {
            ...
            <div class="button2-left">
                <div class="blank">
                    <a class="modal btn" title="'.JText::_('COM_MINITEKWALL_K2_SELECT_AN_ITEM').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 700, y: 450}}">'.JText::_('K2_SELECT').'</a>
                </div>
            </div>
...
class JFormFieldK2Item extends K2ElementK2Item
{
    var $type = 'k2item';
}

class JElementK2Item extends K2ElementK2Item
{
    var $_name = 'k2item';
}
