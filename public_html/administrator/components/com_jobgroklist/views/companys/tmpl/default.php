...
<script language="javascript" type="text/javascript">
    ...
    function tableOrdering( order, dir, task )
    {
        ...
        form.filter_companys_order.value    = order;
        form.filter_companys_order_Dir.value   = dir;
...
<form action="index.php" method="post" name="adminForm" id="adminForm" >
    <div id="editcell">
        <table class='table'>
            <thead>
                <tr>
                    <th width="5"><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_COMPANYS_TMPL_DEFAULT_ID'); ?></th>
                    <th width="20"><input type="checkbox" name="checkall-toggle" value title="Check All" onclick="Joomla.checkAll(this)" /></th>
                    <th style="text-align: left;"><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_COMPANYS_TMPL_DEFAULT_COMPANY'); ?></th>
                    <th style="text-align: left;"><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_COMPANYS_TMPL_DEFAULT_COMPANY_SIZE'); ?></th>
                    <th style="text-align: left;"><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_COMPANYS_TMPL_DEFAULT_COMPANY_REVENUE'); ?></th>
                </tr>
            </thead>
            <?php
            ...
            for ($i = 0, $n = count($this->items); $i < $n; $i++)
            {
                ...
                $link = JRoute :: _('index.php?option=com_jobgroklist&controller=company&task=edit&cid[]=' . $row->id);
                ?>
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td>
                        <?php echo JHTML::_('jobgroklist.static_companysize_description',$row->company_size); ?>
                </td>
                <td>
                        <?php echo JHTML::_('jobgroklist.static_companyrevenue_description',$row->company_revenue); ?>
                </td>
            </tr>
                <?php
