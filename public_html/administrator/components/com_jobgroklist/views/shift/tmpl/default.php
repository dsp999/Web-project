...
<form action="index.php" method="post" name="adminForm" id="adminForm" >
    <div class="col100">
        <fieldset class="adminform">
            <legend><?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_SHIFT_TMPL_DEFAULT_DETAILS'); ?></legend>
            <table class="admintable">
                <tr>
                    <td width="100" align="right" class="key">
                        <label for="shift">
                            <?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_SHIFT_TMPL_DEFAULT_SHIFT'); ?>:
                        </label>
                    </td>
                    <td>
                        <input class="text_area" type="text" name="shift" id="shift" size="32" maxlength="250" value="<?php if (isset($this->shift->shift)) echo $this->shift->shift;?>" />
                    </td>
                </tr>
                <tr>
                    <td width="100" align="right" class="key">
                        <label for="company">
                            <?php echo JTEXT::_('COM_JOBGROKLIST_VIEWS_SHIFT_TMPL_DEFAULT_COMPANY'); ?>:
                        </label>
                    </td>
                    <td>
    ...
    <input type="hidden" name="id" value="<?php if ( isset($this->shift->id)) echo $this->shift->id; ?>" />
