...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="catItemBody mnk2-1">
	  ...
	  <div class="catItemImageBlock">
		  <span class="catItemImage">
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
		    	<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /><span class="mn-image-hover"></span>
		    </a>
		  </span>
		  
          <?php if($this->item->params->get('catItemFeaturedNotice') && $this->item->featured): ?>
          <span class="featured-div">
          </span>
          <?php endif; ?>
    ...
    <!-- Item title -->
	  <h3 class="catItemTitle">
			...
			<span class="catItemEditLink">
				<a class="modal btn btn-primary" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
    ...
    <div class="catItemLinks">
            ...
            <!-- Date created -->
            <div class="itemDate">   
            	<span><?php echo JHTML::_('date', $this->item->created , JText::_('M d')); ?>, <?php echo JHTML::_('date', $this->item->created , JText::_('Y')); ?></span> 
            </div>
            <?php endif; ?>
  ...
  <div class="clr"></div>
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore btn btn-primary" href="<?php echo $this->item->link; ?>">
