...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<span class="userItemAddLink">
			<a class="modal btn btn-primary" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->addLink; ?>">
		  ...
		  <div class="userItemBody">
			  ...
			  <h3 class="userItemTitle">
					...
					<span class="userItemEditLink">
						<a class="modal btn" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $item->editLink; ?>">
			  ...
			  <?php endif; ?>
				...
				<!-- Date created -->
				<div class="itemDate">   
                      <span><?php echo JHTML::_('date', $item->created , JText::_('M d')); ?>, <?php echo JHTML::_('date', $item->created , JText::_('Y')); ?></span> 
                </div>
				<?php endif; ?>
		  ...
		  <?php echo $item->event->K2AfterDisplayTitle; ?>
			  ...
			  <div class="userItemImageBlock">
				  <span class="userItemImage">
				    <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
				    	<img src="<?php echo $item->imageGeneric; ?>" alt="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>" style="width:<?php echo $this->params->get('itemImageGeneric'); ?>px; height:auto;" /><span class="mn-image-hover"></span>
				    </a>
				  </span>
			  ...
			  <div class="userItemTagsBlock">
				  ...
				  <ul class="userItemTags">
				    ...
				    <li><i class="icon-tag"></i><a href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></li>
				    <?php endforeach; ?>
				  </ul>
				  <div class="clr"></div>
			  </div>
			...
			<div class="userItemReadMore">
				<a class="k2ReadMore btn btn-primary" href="<?php echo $item->link; ?>">
	...
	<div class="k2FeedIcon">
		<a href="<?php echo $this->feed; ?>" title="<?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?>">
			<span><i class="fa fa-rss"></i><?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></span>
		</a>
		<div class="clr"></div>
	</div>
	<?php endif; ?>
