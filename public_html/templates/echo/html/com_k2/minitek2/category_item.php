    	...
    	<div class="catItemImageBlock"> 
            ...
            <span class="catItemImage"> 
				...
				<?php if($this->item->params->get('catItemCategory')): ?>
      			...
      			<div class="catItemCommentsLink"> <i class="fa fa-comment"></i>
      			...
      			<div class="catItemDetails">
        			...
        			<h3 class="catItemTitle">
          				...
          				<span class="catItemEditLink"> 
                        	<a class="modal btn btn-primary" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>"> <?php echo JText::_('K2_EDIT_ITEM'); ?> </a> 
                        </span>
          				<?php endif; ?>
        			...
        			<?php if($this->item->params->get('catItemIntroText')): ?>
       				<!-- Item introtext --> 
        			<div class="catItemIntroText-outer">
        			...
        			<div class="catItemReadMore"> 
                    	<a class="k2ReadMore" href="<?php echo $this->item->link; ?>"> 
							<?php echo JText::_('K2_READ_MORE'); ?> <i class="fa fa-chevron-circle-right"></i> 
                        </a> 
                    </div>
        			<?php endif; ?>
