		...
		<div class="genericItemView">
		  ...
		  <div class="genericItemBody">
              ...
              <?php if(
				...
				$item->params->get('genericItemCategory')
				): ?>
				  <div class="genericItemLinks">

					<?php if($this->params->get('genericItemDateCreated')): ?>
                    <div class="itemDate">   
                            <span><?php echo JText::_('MN_POSTED_ON'); ?> <?php echo JHTML::_('date', $item->created , JText::_('M d')); ?>, <?php echo JHTML::_('date', $item->created , JText::_('Y')); ?></span>
              		</div>
					<?php endif; ?>
