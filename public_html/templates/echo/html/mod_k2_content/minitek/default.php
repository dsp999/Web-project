...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> mod_k2_content_minitek">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>"> 
      ...
      <div class="moduleItemBlock">
        ...
        <?php endif; ?>
        <?php if($params->get('itemIntroText') || $params->get('itemTitle') || $params->get('itemDateCreated') || $params->get('itemCommentsCounter') || $params->get('itemAuthor') || $params->get('itemAuthorAvatar')): ?>
        <div class="moduleItemContent">
          ...
          <div class="moduleItemInfo">
            ...
            <?php else: ?>
            <a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>"> <?php echo JText::_('MN_STARTUP_K2_MODULE_NO_COMMENTS'); ?> </a>
            <?php endif; ?>
            <?php endif; ?>
            <?php endif; ?>
            ...
            <div class="moduleItemAuthor">
              ...
              <a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>"> <img src="<?php echo $item->authorAvatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" style="width:<?php echo $avatarWidth; ?>px;height:auto;" /> </a>
              <?php endif; ?>
              <div class="moduleItemAuthorName"> <?php echo K2HelperUtilities::writtenBy($item->authorGender); ?>
            ...
            <div class="moduleItemCategory">
              ...
              <?php echo JText::_('K2_IN') ; ?> <a class="moduleItemCategoryLink" href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a>
              <?php endif; ?>
            </div>
            <div class="clr"></div>
          </div>
        ...
        <div class="clr"></div>
        <div class="moduleItemExtraFields"> <span class="moduleItemExtraFieldsTitle"><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></span>
          <ul>
            ...
            <li class="type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
              ...
              <?php else: ?>
              <span class="moduleItemExtraFieldsLabel"><?php echo $extraField->name; ?></span> <span class="moduleItemExtraFieldsValue"><?php echo $extraField->value; ?></span>
              <?php endif; ?>
              <div class="clr"></div>
            </li>
            <?php endif; ?>
        ...
        <div class="moduleAttachments">
          ...
          <span class="icon-download"> <a title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>" href="<?php echo $attachment->link; ?>"><?php echo $attachment->title; ?></a> </span>
          <?php endforeach; ?>
        </div>
        <?php endif; ?>
        <?php if($params->get('itemTags') && count($item->tags)>0): ?>
        <div class="moduleItemTags"> <b><?php echo JText::_('K2_TAGS'); ?>:</b>
        ...
        <span class="moduleItemHits"> <?php echo JText::_('K2_READ'); ?> <?php echo $item->hits; ?> <?php echo JText::_('K2_TIMES'); ?> </span>
        <?php endif; ?>
